...
#define _INIR			(inl(REG_RTC_INIR)) /*	RTC Initiation Register */
#define _AER			(inl(REG_RTC_AER)) /*	RTC Access Enable Register */
#define _FCR			(inl(REG_RTC_FCR)) /*	RTC Frequency Compensation Register */
#define _TLR			(inl(REG_RTC_TLR)) /*	Time Loading Register */
#define _CLR			(inl(REG_RTC_CLR)) /*	Calendar Loading Register */
#define _TSSR		(inl(REG_RTC_TSSR)) /*	Time Scale Selection Register */
#define _DWR			(inl(REG_RTC_DWR)) /*	Day of the Week Register */
#define _TAR			(inl(REG_RTC_TAR)) /*	Time Alarm Register */
#define _CAR			(inl(REG_RTC_CAR)) /*	Calendar Alarm Register */
#define _LIR			(inl(REG_RTC_LIR)) /*	Leap year Indicator Register */
#define _RIER			(inl(REG_RTC_RIER)) /*	RTC Interrupt Enable Register */
#define _RIIR			(inl(REG_RTC_RIIR)) /*	RTC Interrupt Indicator Register */
#define _TTR			(inl(REG_RTC_TTR)) /*	RTC Time Tick Register */
...
#define CMOS_READ(reg)		inl(reg)
#define CMOS_WRITE(val,reg)	outl(val, reg)
