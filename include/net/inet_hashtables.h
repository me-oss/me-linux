				       ...
				       struct sock *sk, struct sock *child)
{
	...
	volatile  struct inet_bind_hashbucket *head = &table->bhash[bhash];
	volatile  struct inet_bind_bucket *tb;
...
{
	volatile  struct hlist_head *list;
	volatile  rwlock_t *lock;
				  ...
				  const int dif)
{
	 ...
	 */
	volatile unsigned int hash = inet_ehashfn(daddr, hnum, saddr, sport);
	volatile struct inet_ehash_bucket *head = inet_ehash_bucket(hashinfo, hash);
...
static inline struct sock *__inet_lookup(struct inet_hashinfo *hashinfo,
					 ...
					 const int dif)
{
	volatile struct sock *sk = __inet_lookup_established(hashinfo, saddr, sport, daddr,
						    hnum, dif);
