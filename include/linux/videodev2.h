...
#define VID_TYPE_JPEG_DECODER	0x4000	/* Can decode JPEG image */
#define VID_TYPE_JPEG_ENCODER	0x8000	/* Can encode YUV raw data to Jpeg image */
#define VID_TYPE_BLT		0x10000	/* Can bit blitting image */
