...
struct OV_RegValue g_sOV7670_RegValue[] =
{
	...
	{0x55, 0x00},{0x13, 0xE0},{0x00, 0x00},{0x10, 0x00},{0x0D, 0x40},{0x42, 0x00},{0x14, 0x68/*0x18*/},
	...
	{0x79, 0x26},{0x3b,0x8A}/*{0x3b, 0x82}*/,{0x43, 0x02},{0x44, 0xf2},{0xcf,0x8c}
#endif
};
#if 0
...
void mlsSensorOV76XXSetIR(int offon) // off = 0 on = 1
{
    if (offon) // on
    {
	DrvVideoIn_I2cWriteOV(0x42, 0x3B, 0x1A);
	DrvVideoIn_I2cWriteOV(0x42, 0xCF, 0x84);
	DrvVideoIn_I2cWriteOV(0x42, 0x14, 0x68);
    }
    else  //off
    {
	DrvVideoIn_I2cWriteOV(0x42, 0x3B, 0x8A);
