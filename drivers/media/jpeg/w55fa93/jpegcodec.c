...
#if defined(CONFIG_W55FA93_VIDEOIN) 
...
static u32 jpeg_align_width,jpeg_width,g_JPEG_RAW_SIZE = 0, enc_reserved_size = 0, enc_buffer_from_videoin = 0;
	...
	switch (cmd) {
		case JPEG_TRIGGER:
			...
			if(priv->encode)
			{
				...
				{
					_DRVJPEG_SET_BITSTREAM_ADDR(priv->vaddr);
#if defined(CONFIG_W55FA93_VIDEOIN) 
